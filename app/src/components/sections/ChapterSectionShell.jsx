function ChapterSectionShell({
  ...
  return (
    <section
      id={section.id}
      className={`snap-section edu-panel ${sectionClassName} relative flex min-h-screen items-center border-b-8 border-black ${section.bgClass}`}
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-8 md:px-12 md:py-10">
        <article className="reveal max-w-6xl">
          <p className={`inline-block -rotate-2 border-4 border-black px-4 py-2 text-sm font-black tracking-[0.22em] ${labelBgClass}`}>
            {section.label}
          </p>
...
export default ChapterSectionShell
